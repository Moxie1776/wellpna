...
describe('PasswordResetPage', () => {
  ...
  describe('Request Password Reset Mode', () => {
    ...
    it('submits the request reset form successfully', async () => {
      ...
      // Mock useMutation to always return mockRequestResetMutation for
      //  this test
    ...
    it('shows error when email is empty', async () => {
      ...
      // Error should be shown via toast, but since we mock it, we can't test
      // directly
    ...
    it('handles mutation error', async () => {
      ...
      // Mock useMutation to always return mockRequestResetMutation for this
      // test
      ;(useMutation as jest.Mock).mockImplementation(() => [
        { fetching: false },
        mockRequestResetMutation,
  ...
  describe('Reset Password Mode', () => {
    ...
    it('submits the reset password form successfully', async () => {
      ...
      // Mock useMutation to always return mockResetPasswordMutation for this
      // test
      ;(useMutation as jest.Mock).mockImplementation(() => [
        { fetching: false },
        mockResetPasswordMutation,
