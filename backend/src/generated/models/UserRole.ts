...
export type UserRoleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"role", ExtArgs["result"]["userRole"]>
...
export interface UserRoleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const userRoleWithRoleOnly = await prisma.userRole.findMany({ select: { role: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserRoles and only return the `role`
   * const userRoleWithRoleOnly = await prisma.userRole.createManyAndReturn({
   *   select: { role: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more UserRoles and only return the `role`
   * const userRoleWithRoleOnly = await prisma.userRole.updateManyAndReturn({
   *   select: { role: true },
   *   where: {
   *     // ... provide filter here
   *   },
